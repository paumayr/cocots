        ...
        (function (ssw) {
            ...
            (function (Coco) {
                ...
                var Generator = (function () {
                    ...
                    Generator.prototype.CopyFramePart2 = // if stop == null, copies until end of file
                    function (stop, generateOutput) {
                        var startCh = '\0000';
                ...
                var DFA = (function () {
                    ...
                    DFA.prototype.NewState = //---------- State handling
                    function () {
                        var s = new State();
                    ...
                    DFA.prototype.DeleteRedundantStates = function () {
                        ...
                        var used = new Coco.BitArray(this.lastStateNr + 1);
                    ...
                    DFA.prototype.Step = function (from, p, stepped) {
                        ...
                        switch(p.typ) {
                            ...
                            case Node.iter: {
                                ...
                                this.Step(from, p.sub, stepped);
                                if(p.state != from) {
                                    this.Step(p.state, p, new Coco.BitArray(this.tab.nodes.Count));
                                }
                                break;
                            }
                            case Node.opt: {
                    ...
                    DFA.prototype.NumberNodes = // Assigns a state n.state to every node n. There will be a transition from
                    ...
                    DFA.prototype.FindTrans = function (p, start, marked) {
                        ...
                        marked[p.n] = true;
                        if(start) {
                            this.Step(p.state, p, new Coco.BitArray(this.tab.nodes.Count))// start of group of equally numbered nodes
                            ;
                        }
                        switch(p.typ) {
                            case Node.clas:
                    ...
                    DFA.prototype.ConvertToStates = function (p, sym) {
                        ...
                        this.FindTrans(p, true, new Coco.BitArray(this.tab.nodes.Count));
                        if(p.typ == Node.iter) {
                            this.Step(this.firstState, p, new Coco.BitArray(this.tab.nodes.Count));
                        }
                    };
                    DFA.prototype.MatchLiteral = // match string against current automaton; store it either as a fixedToken or as a litToken
                    function (s, sym) {
                    ...
                    DFA.prototype.FindAction = //---------------------------- actions --------------------------------
                    function (state, ch) {
                        for(var a = state.firstAction; a != null; a = a.next) {
                    ...
                    DFA.prototype.GetTargetStates = function (a) {
                        ...
                        ret.endOf = null;
                        ret.ctx = false;
                        ret.targets = new Coco.BitArray(this.maxStates);
                    ...
                    DFA.prototype.NewMelted = // head of melted state list
                    function (set, state) {
                    ...
                    DFA.prototype.CommentStr = // list of comments
                    function (p) {
                    ...
                    DFA.prototype.GenComBody = //------------------------ scanner generation ----------------------
                    function (com) {
